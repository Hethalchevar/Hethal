...
<MDBRow>
  ...
  <MDBCol col='4' md='6'>
    ...
    <MDBInput onChange={HandleChange} wrapperClass='mb-4' label='Email address' id='formControlLg' type='email' size="lg" name='email'/>
    <MDBInput onChange={HandleChange} wrapperClass='mb-4' label='Password' id='formControlLg' type='password' size="lg" name='password'/>
